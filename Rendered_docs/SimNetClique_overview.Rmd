...
Name stands for similarity network clique based clustering and describes its main mechanism.
...
To find optimal threshold by `compexity` of a clique partition, we subject $G_{\mathbf{S}}$ to candidate threshold $t$ and calculate complexity for cliques found on this $t$ (see docs of `cliqueClusteR::thr_optimizer`).
